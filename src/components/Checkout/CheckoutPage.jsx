            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <label className="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                  ...
                  />
                  <span className="ml-3 font-semibold text-gray-900">Transfer Bank</span>
                </label>
                ...
                <label className="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                  <input
                    ...
                    className="w-4 h-4 text-blue-600"
                  />
                  <span className="ml-3 font-semibold text-gray-900">E-Wallet</span>
                </label>
                ...
                <label className="flex items-center p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                  <input
                    ...
                    className="w-4 h-4 text-blue-600"
                  />
                  <span className="ml-3 font-semibold text-gray-900">Tunai</span>
                </label>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl max-w-lg w-full p-6 shadow-lg">
            ...
            <div className="space-y-6">
              <div className="bg-blue-50 p-4 rounded-lg shadow-md">
                <p className="text-sm text-gray-700 mb-1">Total Pembayaran</p>
              ...
              {(paymentMethod === 'Transfer Bank' || paymentMethod === 'E-Wallet') && (
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <button
                      onClick={() => {
                        navigator.clipboard.writeText(Math.random().toString().slice(2, 12));
                        setCopied(true);
              ...
              <div className="bg-gray-50 p-4 rounded-lg shadow-md">
                <p className="text-sm text-gray-600 mb-2">Instruksi Pembayaran:</p>
                <ol className="list-decimal list-inside text-gray-700 space-y-2">
                  {paymentMethod === 'Tunai' ? (
                    ...
                    <>
                      ...
                      <li>Buka aplikasi {subMethod || 'pembayaran'} Anda.</li>
